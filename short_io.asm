...
user/_short_io:     file format elf64-littleriscv
...
main(int argc, char *argv[])
{
  ...
  16:	7f6a0a13          	addi	s4,s4,2038 # 808 <malloc+0xe4>
        ...
        while (read(fd1, &buf, sizeof(buf)) > 0) {
            printf("%c", buf);
  1a:	00001917          	auipc	s2,0x1
  1e:	80690913          	addi	s2,s2,-2042 # 820 <malloc+0xfc>
  22:	a815                	j	56 <main+0x56>
  24:	fcf44583          	lbu	a1,-49(s0)
  28:	854a                	mv	a0,s2
  2a:	00000097          	auipc	ra,0x0
  2e:	63c080e7          	jalr	1596(ra) # 666 <printf>
        while (read(fd1, &buf, sizeof(buf)) > 0) {
  32:	4605                	li	a2,1
  34:	fcf40593          	addi	a1,s0,-49
  38:	8526                	mv	a0,s1
  3a:	00000097          	auipc	ra,0x0
  3e:	2bc080e7          	jalr	700(ra) # 2f6 <read>
  42:	fea041e3          	bgtz	a0,24 <main+0x24>
        }
  ...
  5e:	2c4080e7          	jalr	708(ra) # 31e <open>
  62:	84aa                	mv	s1,a0
        while (read(fd1, &buf, sizeof(buf)) > 0) {
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d6:	45e50513          	addi	a0,a0,1118 # 830 <digits>
 3da:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a2:	392b8b93          	addi	s7,s7,914 # 830 <digits>
 ...
 5e2:	24a90913          	addi	s2,s2,586 # 828 <malloc+0x104>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6aa:	1a27b783          	ld	a5,418(a5) # 848 <freep>
 ...
 6d8:	00e6ea63          	bltu	a3,a4,6ec <free+0x50>
{
 ...
 71a:	12f73923          	sd	a5,306(a4) # 848 <freep>
}
 71e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 74c:	10053503          	ld	a0,256(a0) # 848 <freep>
 ...
 774:	0d890913          	addi	s2,s2,216 # 848 <freep>
  if(p == (char*)-1)
 778:	5afd                	li	s5,-1
 77a:	a88d                	j	7ec <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 77c:	00000797          	auipc	a5,0x0
 780:	0d478793          	addi	a5,a5,212 # 850 <base>
 784:	00000717          	auipc	a4,0x0
 788:	0cf73223          	sd	a5,196(a4) # 848 <freep>
 78c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
