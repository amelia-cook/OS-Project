...
user/_short_cpu:     file format elf64-littleriscv
...
int main() {
  ...
  12:	81273707          	fld	fa4,-2030(a4) # 820 <__SDATA_BEGIN__>
        x += i;
  16:	fe843703          	ld	a4,-24(s0)
  1a:	973e                	add	a4,a4,a5
  1c:	fee43423          	sd	a4,-24(s0)
    for (long i = 0; i < 5e7; i++) {   // short CPU loop
  20:	0785                	addi	a5,a5,1
  22:	d227f7d3          	fcvt.d.l	fa5,a5
  26:	a2e79753          	flt.d	a4,fa5,fa4
  2a:	f775                	bnez	a4,16 <main+0x16>
    }
    printf("cpu_short done: %ld\n", x);
  2c:	fe843583          	ld	a1,-24(s0)
  30:	00000517          	auipc	a0,0x0
  34:	7b850513          	addi	a0,a0,1976 # 7e8 <malloc+0xea>
  38:	00000097          	auipc	ra,0x0
  3c:	608080e7          	jalr	1544(ra) # 640 <printf>
    exit(0);
  40:	4501                	li	a0,0
  42:	00000097          	auipc	ra,0x0
  46:	276080e7          	jalr	630(ra) # 2b8 <exit>
...
free(void *ap)
{
 ...
 684:	1a87b783          	ld	a5,424(a5) # 828 <freep>
 ...
 6b2:	00e6ea63          	bltu	a3,a4,6c6 <free+0x50>
{
 ...
 6f4:	12f73c23          	sd	a5,312(a4) # 828 <freep>
}
 6f8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 726:	10653503          	ld	a0,262(a0) # 828 <freep>
 ...
 74e:	0de90913          	addi	s2,s2,222 # 828 <freep>
  if(p == (char*)-1)
 752:	5afd                	li	s5,-1
 754:	a88d                	j	7c6 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 756:	00000797          	auipc	a5,0x0
 75a:	0da78793          	addi	a5,a5,218 # 830 <base>
 75e:	00000717          	auipc	a4,0x0
 762:	0cf73523          	sd	a5,202(a4) # 828 <freep>
 766:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 788:	0aa73223          	sd	a0,164(a4) # 828 <freep>
      return (void*)(p + 1);
