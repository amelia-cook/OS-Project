...
void test0()
{
  ...
  24:	5c0080e7          	jalr	1472(ra) # 5e0 <ntas>
  for(int i = 0; i < NCHILD; i++){
    int pid = fork();
  28:	00000097          	auipc	ra,0x0
  2c:	510080e7          	jalr	1296(ra) # 538 <fork>
    if(pid < 0){
  ...
  3a:	502080e7          	jalr	1282(ra) # 538 <fork>
    if(pid < 0){
  ...
  4a:	502080e7          	jalr	1282(ra) # 548 <wait>
  4e:	4501                	li	a0,0
  50:	00000097          	auipc	ra,0x0
  54:	4f8080e7          	jalr	1272(ra) # 548 <wait>
  }
  ...
  6e:	576080e7          	jalr	1398(ra) # 5e0 <ntas>
  if(n < 10) 
  72:	47a5                	li	a5,9
  ...
  ac:	498080e7          	jalr	1176(ra) # 540 <exit>
{
  b0:	6961                	lui	s2,0x18
  ...
  be:	50e080e7          	jalr	1294(ra) # 5c8 <sbrk>
  c2:	84aa                	mv	s1,a0
        *(int *)(a+4) = 1;
  ...
  ce:	4fe080e7          	jalr	1278(ra) # 5c8 <sbrk>
        if (a1 != a + 4096) {
  d2:	6785                	lui	a5,0x1
  ...
  e6:	45e080e7          	jalr	1118(ra) # 540 <exit>
          printf("wrong sbrk\n");
 ...
 100:	444080e7          	jalr	1092(ra) # 540 <exit>
    printf("test0 FAIL\n");
...
0000000000000116 <main>:
{
 ...
 12c:	418080e7          	jalr	1048(ra) # 540 <exit>
...
void test1()
{
 ...
 142:	99250513          	addi	a0,a0,-1646 # ad0 <malloc+0x14a>
 146:	00000097          	auipc	ra,0x0
 14a:	782080e7          	jalr	1922(ra) # 8c8 <printf>
  for(int i = 0; i < NCHILD; i++){
 ...
 15a:	3fa080e7          	jalr	1018(ra) # 550 <pipe>
 15e:	84aa                	mv	s1,a0
 ...
 166:	3d6080e7          	jalr	982(ra) # 538 <fork>
    if(pid < 0){
 ...
 178:	3f4080e7          	jalr	1012(ra) # 568 <close>
      pipes[i] = fds[0];
 ...
 18e:	a85d                	j	244 <test1+0x114>
      printf("pipe() failed\n");
 190:	00001517          	auipc	a0,0x1
 194:	95050513          	addi	a0,a0,-1712 # ae0 <malloc+0x15a>
 198:	00000097          	auipc	ra,0x0
 19c:	730080e7          	jalr	1840(ra) # 8c8 <printf>
      exit(-1);
 1a0:	557d                	li	a0,-1
 1a2:	00000097          	auipc	ra,0x0
 1a6:	39e080e7          	jalr	926(ra) # 540 <exit>
      printf("fork failed");
 1aa:	00001517          	auipc	a0,0x1
 1ae:	8d650513          	addi	a0,a0,-1834 # a80 <malloc+0xfa>
 1b2:	00000097          	auipc	ra,0x0
 1b6:	716080e7          	jalr	1814(ra) # 8c8 <printf>
      exit(-1);
 1ba:	557d                	li	a0,-1
 1bc:	00000097          	auipc	ra,0x0
 1c0:	384080e7          	jalr	900(ra) # 540 <exit>
      close(fds[0]);
 1c4:	fb842503          	lw	a0,-72(s0)
 1c8:	00000097          	auipc	ra,0x0
 1cc:	3a0080e7          	jalr	928(ra) # 568 <close>
 1d0:	64e1                	lui	s1,0x18
 1d2:	6a048493          	addi	s1,s1,1696 # 186a0 <__global_pointer$+0x17307>
        *(int *)(a+4) = 1;
 1d6:	4905                	li	s2,1
        if (write(fds[1], "x", 1) != 1) {
 1d8:	00001997          	auipc	s3,0x1
 1dc:	91898993          	addi	s3,s3,-1768 # af0 <malloc+0x16a>
        a = sbrk(PGSIZE);
 1e0:	6505                	lui	a0,0x1
 1e2:	00000097          	auipc	ra,0x0
 1e6:	3e6080e7          	jalr	998(ra) # 5c8 <sbrk>
        *(int *)(a+4) = 1;
 1ea:	01252223          	sw	s2,4(a0) # 1004 <__BSS_END__+0x44c>
        if (write(fds[1], "x", 1) != 1) {
 1ee:	864a                	mv	a2,s2
 1f0:	85ce                	mv	a1,s3
 1f2:	fbc42503          	lw	a0,-68(s0)
 1f6:	00000097          	auipc	ra,0x0
 1fa:	36a080e7          	jalr	874(ra) # 560 <write>
 1fe:	01251963          	bne	a0,s2,210 <test1+0xe0>
      for(i = 0; i < N; i++) {
 202:	34fd                	addiw	s1,s1,-1
 204:	fcf1                	bnez	s1,1e0 <test1+0xb0>
      exit(0);
 206:	4501                	li	a0,0
 208:	00000097          	auipc	ra,0x0
 20c:	338080e7          	jalr	824(ra) # 540 <exit>
          printf("write failed");
 210:	00001517          	auipc	a0,0x1
 214:	8e850513          	addi	a0,a0,-1816 # af8 <malloc+0x172>
 218:	00000097          	auipc	ra,0x0
 21c:	6b0080e7          	jalr	1712(ra) # 8c8 <printf>
          exit(-1);
 220:	557d                	li	a0,-1
 222:	00000097          	auipc	ra,0x0
 226:	31e080e7          	jalr	798(ra) # 540 <exit>
  int stop = 0;
  while (!stop) {
    stop = 1;
    for(int i = 0; i < NCHILD; i++){
 ...
 232:	fcc42503          	lw	a0,-52(s0)
 236:	00000097          	auipc	ra,0x0
 23a:	322080e7          	jalr	802(ra) # 558 <read>
 23e:	4785                	li	a5,1
 240:	02f50a63          	beq	a0,a5,274 <test1+0x144>
 244:	4605                	li	a2,1
 246:	fc040593          	addi	a1,s0,-64
 24a:	fc842503          	lw	a0,-56(s0)
 24e:	00000097          	auipc	ra,0x0
 252:	30a080e7          	jalr	778(ra) # 558 <read>
 256:	4785                	li	a5,1
 258:	fcf509e3          	beq	a0,a5,22a <test1+0xfa>
 25c:	4605                	li	a2,1
 25e:	fc040593          	addi	a1,s0,-64
 262:	fcc42503          	lw	a0,-52(s0)
 266:	00000097          	auipc	ra,0x0
 26a:	2f2080e7          	jalr	754(ra) # 558 <read>
 26e:	4785                	li	a5,1
 270:	02f51163          	bne	a0,a5,292 <test1+0x162>
        tot += 1;
 274:	2485                	addiw	s1,s1,1
  while (!stop) {
 276:	b7f9                	j	244 <test1+0x114>
    }
  }
 ...
 27c:	89050513          	addi	a0,a0,-1904 # b08 <malloc+0x182>
 280:	00000097          	auipc	ra,0x0
 284:	648080e7          	jalr	1608(ra) # 8c8 <printf>
    exit(-1);
 288:	557d                	li	a0,-1
 28a:	00000097          	auipc	ra,0x0
 28e:	2b6080e7          	jalr	694(ra) # 540 <exit>
  printf("total allocated number of pages: %d (out of %d)\n", tot, n);
 292:	6621                	lui	a2,0x8
 294:	85a6                	mv	a1,s1
 296:	00001517          	auipc	a0,0x1
 29a:	8b250513          	addi	a0,a0,-1870 # b48 <malloc+0x1c2>
 29e:	00000097          	auipc	ra,0x0
 2a2:	62a080e7          	jalr	1578(ra) # 8c8 <printf>
  if(n - tot > 1000) {
 2a6:	67a1                	lui	a5,0x8
 2a8:	409784bb          	subw	s1,a5,s1
 2ac:	3e800793          	li	a5,1000
 2b0:	fc97c4e3          	blt	a5,s1,278 <test1+0x148>
  }
  printf("test1 OK\n");  
 2b4:	00001517          	auipc	a0,0x1
 2b8:	88450513          	addi	a0,a0,-1916 # b38 <malloc+0x1b2>
 2bc:	00000097          	auipc	ra,0x0
 2c0:	60c080e7          	jalr	1548(ra) # 8c8 <printf>
}
 2c4:	60a6                	ld	ra,72(sp)
 2c6:	6406                	ld	s0,64(sp)
 2c8:	74e2                	ld	s1,56(sp)
 2ca:	7942                	ld	s2,48(sp)
 2cc:	79a2                	ld	s3,40(sp)
 2ce:	6161                	addi	sp,sp,80
 2d0:	8082                	ret
...
strcpy(char *s, const char *t)
{
 ...
 2e2:	fee78fa3          	sb	a4,-1(a5) # 7fff <__global_pointer$+0x6c66>
...
malloc(uint nbytes)
{
 ...
 a10:	18a73a23          	sd	a0,404(a4) # ba0 <freep>
      return (void*)(p + 1);
