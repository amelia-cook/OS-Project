...
forktest(void)
{
  ...
  3e:	56e50513          	addi	a0,a0,1390 # 5a8 <malloc+0xe4>
  ...
  68:	55450513          	addi	a0,a0,1364 # 5b8 <malloc+0xf4>
  ...
  b8:	55450513          	addi	a0,a0,1364 # 608 <malloc+0x144>
  ...
  d4:	50850513          	addi	a0,a0,1288 # 5d8 <malloc+0x114>
  ...
  ee:	50650513          	addi	a0,a0,1286 # 5f0 <malloc+0x12c>
...
free(void *ap)
{
 ...
 440:	0800                	addi	s0,sp,16
  ...
  bp = (Header*)ap - 1;
 442:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 446:	00000797          	auipc	a5,0x0
 44a:	1d27b783          	ld	a5,466(a5) # 618 <freep>
 44e:	a805                	j	47e <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
 450:	4618                	lw	a4,8(a2)
 452:	9db9                	addw	a1,a1,a4
 454:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
 458:	6398                	ld	a4,0(a5)
 45a:	6318                	ld	a4,0(a4)
 45c:	fee53823          	sd	a4,-16(a0)
 460:	a091                	j	4a4 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
 462:	ff852703          	lw	a4,-8(a0)
 466:	9e39                	addw	a2,a2,a4
 468:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
 46a:	ff053703          	ld	a4,-16(a0)
 46e:	e398                	sd	a4,0(a5)
 470:	a099                	j	4b6 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 472:	6398                	ld	a4,0(a5)
 474:	00e7e463          	bltu	a5,a4,47c <free+0x40>
 478:	00e6ea63          	bltu	a3,a4,48c <free+0x50>
{
 47c:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 47e:	fed7fae3          	bgeu	a5,a3,472 <free+0x36>
 482:	6398                	ld	a4,0(a5)
 484:	00e6e463          	bltu	a3,a4,48c <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 488:	fee7eae3          	bltu	a5,a4,47c <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
 48c:	ff852583          	lw	a1,-8(a0)
 490:	6390                	ld	a2,0(a5)
 492:	02059713          	slli	a4,a1,0x20
 496:	9301                	srli	a4,a4,0x20
 498:	0712                	slli	a4,a4,0x4
 49a:	9736                	add	a4,a4,a3
 49c:	fae60ae3          	beq	a2,a4,450 <free+0x14>
    bp->s.ptr = p->s.ptr;
 4a0:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 4a4:	4790                	lw	a2,8(a5)
 4a6:	02061713          	slli	a4,a2,0x20
 4aa:	9301                	srli	a4,a4,0x20
 4ac:	0712                	slli	a4,a4,0x4
 4ae:	973e                	add	a4,a4,a5
 4b0:	fae689e3          	beq	a3,a4,462 <free+0x26>
  } else
    p->s.ptr = bp;
 4b4:	e394                	sd	a3,0(a5)
  freep = p;
 4b6:	00000717          	auipc	a4,0x0
 4ba:	16f73123          	sd	a5,354(a4) # 618 <freep>
}
 4be:	6422                	ld	s0,8(sp)
 4c0:	0141                	addi	sp,sp,16
 4c2:	8082                	ret

00000000000004c4 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
 ...
 4d8:	02051493          	slli	s1,a0,0x20
 4dc:	9081                	srli	s1,s1,0x20
 4de:	04bd                	addi	s1,s1,15
 4e0:	8091                	srli	s1,s1,0x4
 4e2:	0014899b          	addiw	s3,s1,1
 4e6:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
 4e8:	00000517          	auipc	a0,0x0
 4ec:	13053503          	ld	a0,304(a0) # 618 <freep>
 4f0:	c515                	beqz	a0,51c <malloc+0x58>
 ...
 4f2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 4f4:	4798                	lw	a4,8(a5)
 4f6:	02977f63          	bgeu	a4,s1,534 <malloc+0x70>
 4fa:	8a4e                	mv	s4,s3
 4fc:	0009871b          	sext.w	a4,s3
 500:	6685                	lui	a3,0x1
 502:	00d77363          	bgeu	a4,a3,508 <malloc+0x44>
 506:	6a05                	lui	s4,0x1
 508:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
 50c:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
 ...
 514:	10890913          	addi	s2,s2,264 # 618 <freep>
  if(p == (char*)-1)
 518:	5afd                	li	s5,-1
 51a:	a88d                	j	58c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 51c:	00000797          	auipc	a5,0x0
 520:	10478793          	addi	a5,a5,260 # 620 <base>
 524:	00000717          	auipc	a4,0x0
 528:	0ef73a23          	sd	a5,244(a4) # 618 <freep>
 52c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 52e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
 532:	b7e1                	j	4fa <malloc+0x36>
      if(p->s.size == nunits)
 534:	02e48b63          	beq	s1,a4,56a <malloc+0xa6>
        p->s.size -= nunits;
 538:	4137073b          	subw	a4,a4,s3
 53c:	c798                	sw	a4,8(a5)
        p += p->s.size;
 53e:	1702                	slli	a4,a4,0x20
 540:	9301                	srli	a4,a4,0x20
 542:	0712                	slli	a4,a4,0x4
 544:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
 546:	0137a423          	sw	s3,8(a5)
      freep = prevp;
 54a:	00000717          	auipc	a4,0x0
 54e:	0ca73723          	sd	a0,206(a4) # 618 <freep>
      return (void*)(p + 1);
 552:	01078513          	addi	a0,a5,16
 ...
 56a:	6398                	ld	a4,0(a5)
 56c:	e118                	sd	a4,0(a0)
 56e:	bff1                	j	54a <malloc+0x86>
  hp->s.size = nu;
 570:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 574:	0541                	addi	a0,a0,16
 576:	00000097          	auipc	ra,0x0
 57a:	ec6080e7          	jalr	-314(ra) # 43c <free>
  return freep;
 57e:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 582:	d971                	beqz	a0,556 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 584:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 586:	4798                	lw	a4,8(a5)
 588:	fa9776e3          	bgeu	a4,s1,534 <malloc+0x70>
    if(p == freep)
 58c:	00093703          	ld	a4,0(s2)
 590:	853e                	mv	a0,a5
 592:	fef719e3          	bne	a4,a5,584 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
 596:	8552                	mv	a0,s4
 598:	00000097          	auipc	ra,0x0
 59c:	e7c080e7          	jalr	-388(ra) # 414 <sbrk>
  if(p == (char*)-1)
 5a0:	fd5518e3          	bne	a0,s5,570 <malloc+0xac>
        return 0;
 5a4:	4501                	li	a0,0
 5a6:	bf45                	j	556 <malloc+0x92>
