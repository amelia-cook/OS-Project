...
user/_long_io:     file format elf64-littleriscv
...
main(int argc, char *argv[])
{
  ...
  10:	02d00993          	li	s3,45
    for (int i = 0; i < 45; i++) {
        int fd1 = open("pride-and-prejudice-small.txt", O_RDONLY);
  14:	00000a17          	auipc	s4,0x0
  18:	7fca0a13          	addi	s4,s4,2044 # 810 <malloc+0xea>
        char buf;
        
        while (read(fd1, &buf, sizeof(buf)) > 0) {
            printf("%c", buf);
  1c:	00001917          	auipc	s2,0x1
  20:	81490913          	addi	s2,s2,-2028 # 830 <malloc+0x10a>
  24:	a815                	j	58 <main+0x58>
  26:	fcf44583          	lbu	a1,-49(s0)
  2a:	854a                	mv	a0,s2
  2c:	00000097          	auipc	ra,0x0
  30:	63c080e7          	jalr	1596(ra) # 668 <printf>
        while (read(fd1, &buf, sizeof(buf)) > 0) {
  34:	4605                	li	a2,1
  36:	fcf40593          	addi	a1,s0,-49
  3a:	8526                	mv	a0,s1
  3c:	00000097          	auipc	ra,0x0
  40:	2bc080e7          	jalr	700(ra) # 2f8 <read>
  44:	fea041e3          	bgtz	a0,26 <main+0x26>
        }
        
        close(fd1);
  48:	8526                	mv	a0,s1
  4a:	00000097          	auipc	ra,0x0
  4e:	2be080e7          	jalr	702(ra) # 308 <close>
    for (int i = 0; i < 45; i++) {
  52:	39fd                	addiw	s3,s3,-1
  54:	00098a63          	beqz	s3,68 <main+0x68>
        int fd1 = open("pride-and-prejudice-small.txt", O_RDONLY);
  58:	4581                	li	a1,0
  5a:	8552                	mv	a0,s4
  5c:	00000097          	auipc	ra,0x0
  60:	2c4080e7          	jalr	708(ra) # 320 <open>
  64:	84aa                	mv	s1,a0
        while (read(fd1, &buf, sizeof(buf)) > 0) {
  66:	b7f9                	j	34 <main+0x34>
    }
    exit(0);
  68:	4501                	li	a0,0
  6a:	00000097          	auipc	ra,0x0
  6e:	276080e7          	jalr	630(ra) # 2e0 <exit>
...
gets(char *buf, int max)
{
 ...
 160:	19c080e7          	jalr	412(ra) # 2f8 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1b2:	172080e7          	jalr	370(ra) # 320 <open>
  if(fd < 0)
 ...
 1c2:	17a080e7          	jalr	378(ra) # 338 <fstat>
 1c6:	892a                	mv	s2,a0
  close(fd);
 1c8:	8526                	mv	a0,s1
 1ca:	00000097          	auipc	ra,0x0
 1ce:	13e080e7          	jalr	318(ra) # 308 <close>
  return r;
}
 1d2:	854a                	mv	a0,s2
